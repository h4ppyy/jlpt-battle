...
const getMypageInfoController = require('../controllers/getMypageInfo')
const getUserRankController = require('../controllers/getUserRank')
...
router.post('/api/getUserRank', getUserRankController.getUserRank)
